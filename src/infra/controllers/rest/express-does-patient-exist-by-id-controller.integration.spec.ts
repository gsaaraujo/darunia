...
describe('express-does-patient-exist-by-id-controller', () => {
  ...
  it('should succeed and return true', async () => {
    ...
    const sut = await request('http://localhost:3000').get('/doctors/84e75ed0-4f21-4319-956a-5a5dae3e90c0/exists');
  ...
  it('should fail if id is not uuid', async () => {
    const sut = await request('http://localhost:3000').get('/doctors/5a5dae3e084e75ed0/exists');
